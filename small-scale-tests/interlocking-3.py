...
import stl2inp
stl2inp.STL2inp(stlfile='/home/data/schnelle/Interlocking-Simulations/interlocking-3.stl', 
    modelName=modelName, mergeNodesTolerance=1E-10)

stl2inp.STL2inp(stlfile='/home/data/schnelle/Interlocking-Simulations/frame-3.stl', 
