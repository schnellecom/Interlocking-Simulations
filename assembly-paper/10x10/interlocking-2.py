...
jobName = "p4-small-gaps"
interlockingName = "interlocking-2"
frameName = "frame-2"
...
step = mdb.openStep(
    '/home/data/schnelle/Interlocking-Simulations/10x10/interlocking-2.step',
    scaleFromFile=OFF)
...
step = mdb.openStep(
    '/home/data/schnelle/Interlocking-Simulations/10x10/frame-2.step',
    scaleFromFile=OFF)
